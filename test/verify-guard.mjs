...
const cmd = `$c = "D:\\example workspace\\dsh-project\\archive\\npm-cache-tmp3"; New-Item -ItemType Directory -Force -Path $c | Out-Null; Get-Item "D:\\example workspace\\.dsh\\profiles\\web\\node_modules\\dshmarket\\data\\registry-snapshot.json" | Select-Object Name, Length`;
