...
const cmd = `Copy-Item 'D:\\example\\apps\\comfy-desktop\\ComfyUI-Installs\\ComfyUI\\ComfyUI\\.venv\\Lib\\site-packages\\comfyui_workflow_templates_json\\templates\\video_minimax_h3_t2v.json' 'D:\\example workspace\\dsh-project\\video_minimax_h3_t2v_local.json' -Force`;
