...
hit = guardDecision(state, { name: "write", arguments: { file_path: "D:/example workspace/dsh-project/projects/rule-guard-dev/dsh-rule-engine/test/中文.ps1", content: "Write-Output '中文'" } });
assert.ok(hit && hit.ruleId === "9", "deny Chinese ps1 write");
hit = guardDecision(state, { name: "write", arguments: { file_path: "D:/example workspace/dsh-project/projects/rule-guard-dev/dsh-rule-engine/test/ok.ps1", content: "Write-Output 'ascii'" } });
...
const exec = { name: "edit", arguments: { file_path: "D:/example workspace/dsh-project/projects/rule-guard-dev/dsh-rule-engine/test/x.txt", old_string: "a", new_string: "b" } };
...
hit = guardDecision(stateManual, { name: "edit", arguments: { file_path: "D:/example workspace/.dsh/skills/example-usage-manual/SKILL.md", old_string: "a", new_string: "b" } });
