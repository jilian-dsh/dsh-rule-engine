...
hit = guardDecision(state, { name: "write", arguments: { file_path: "D:/example workspace/dsh-project/projects/oss/dsh-rule-engine/test/ok.ps1", content: "Write-Output 'ascii'" } });
