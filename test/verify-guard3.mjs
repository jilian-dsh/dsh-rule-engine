...
const cmd = `$env:HTTPS_PROXY = "http://127.0.0.1:7890"; $env:HTTP_PROXY = "http://127.0.0.1:7890"; gh release create v0.4.1 "D:\\example workspace\\dsh-project\\projects\\oss\\dsh-rule-engine\\dsh-rule-engine-0.4.1.tgz" --repo jilian-dsh/dsh-rule-engine --title "dsh-rule-engine v0.4.1" --notes "## v0.4.1
