...
export const PATTERN_MAP_KEYS = {
  self_cert_hints: {
    "10": "(?:new session|old session|old project|context recovery)",
    "14": "(?:summary|report|done)",
    "15": "(?:file version|file purpose|old/new|version.*disposition|keep file)",
    "16": "(?:suggest|optimi[sz]e|better option|reasoning effort)",
    "19": "(?:learned.*DSH|new pitfall|pitfall.*sediment|manual wrong|knowledge sediment)",
    "22": "(?:got it|noted|i'?ll remember)",
    "23": "(?:done|delivered)",
    "26": "(?=release|asset)(?!(?:Attach binaries|release\\.assets))",
    "28": "(?:new.*file|into.*directory|workspace.*classif)",
    "29": "(?:dependency closure|node_modules.*verif|touched.*node_modules)",
    "30": "(?:change verif|verification evidence|break.*dependenc)",
    "31": "(?:hit a wall|blind trial|random trial)",
    "12E": "(?:restart|gui|login|interface|window)",
    "12C": "(?:download|network|curl|proxy|blocked)",
    "13B": "(?:session file|session repair|fromRestore|inbox replay|orphan scan)"
  }
};
